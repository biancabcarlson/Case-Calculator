...
if __name__ == "__main__":
    # Synthetic demonstration data — Case CASE-DEMO-0091:
    # a $4,800 withdrawal to a newly added external payee, flagged and
    # held before it could settle.
    case = calculate_case(
        gross_exposure=4800.00,
        confirmed_loss=0.00,
        prevented_loss=4800.00,
        recovered=0.00,
    )
